...
Transpose tous les accords de la grille d'un nombre de demi-tons (entre -12 et +12).  
Saisissez la valeur souhaitée dans le champ demi-tons et cliquez sur `Appliquer`.  
Les champs de saisie des accords passent en lecture seule lors d'une transposition active — remettez la valeur à 0 pour reprendre l'édition.

> 💡
> La transposition est non-destructive : les accords originaux sont conservés et restaurés lorsque vous remettez la valeur à 0.

<img src="/assets/images/transpose.png" width="200px"/>
